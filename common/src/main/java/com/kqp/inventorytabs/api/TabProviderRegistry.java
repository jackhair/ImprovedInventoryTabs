...
public class TabProviderRegistry {
     ...
     */
    private static final List<ResourceLocation> MENU_BLOCKS_WITHOUT_PROVIDER = List.of(
            new ResourceLocation("fastpipes", "terminal"),
            new ResourceLocation("create", "stock_ticker"));
    ...
    private static void configRemove(Set<String> blockSet) {
        for (String overrideEntry : blockSet) {
            ...
            removeBlock(new ResourceLocation(overrideEntry));
        }
    }
